...
!     *   ', COMPUTED BY POLFIT -- EXECUTION TERMINATED.', 8, 2)
      if ( iverb.gt.0 ) 
     x     write(*,*) "pvalue: The order of the polynomial (" //XERN1//
     x     ") exceeds the highest-allowed order (" //XERN2//
...
!     +   'REQUESTED IS NEGATIVE -- EXECUTION TERMINATED.', 2, 2)
 12   if ( iverb.gt.0 ) 
     x     write(*,*) "pvalue: Invalid input parameter.  Requested "//
     x     "polynomial order is negative.  Execution terminated."
      RETURN
      END
