...
C
!!!!  Modified by J. Harris for StarFISH:
!!!!  Replaced "xermsg" calls with my own error message routine
!!!!
!!!!  This file is in the public domain; I obtained it from:
...
c     +   1)
      if ( iverb.gt.0 ) 
     x     write(*,*) "polfit: Invalid input parameter."
